                    ...
                    foreach ($resultado as $fila) {
                        if (strpos($fila['fecha'], $_GET['buscar']) !== false) {
                            echo "<tr>
                                    ...
                                    <td><a href='' class='btn__autorizar' onclick=\"window.open('../verautorizacion/ver_autorizacion.php?id_cita={$fila['id_cita']}','','width=1000,height=700,toolbar=NO');void(null);\">Ver Auto.Medica</a></td>
                                  </tr>";
                        }
                    }
                } else {
