    ...
    <div class="contenedor">
        ...
        <div class="row mt-3">
            ...
            <div class="barra_buscador">
                <form action="historia.php" class="formulario" method="GET">
                    <input type="text" name="buscar" placeholder="Buscar Historia" class="input_text">
                ...
                if (isset($_GET['btn_buscar'])) {
                    foreach ($resultado as $fila) {
                        if (strpos($fila['fecha'], $_GET['buscar']) !== false) {
                            echo "<tr>
                                    ...
                                    <td>{$fila['estado']}</td>
                                    <td><a href='' class='btn__autorizar' onclick=\"window.open('../histo_clinica/verhisto_clinica.php?id_cita={$fila['id_cita']}','','width=1000,height=700,toolbar=NO');void(null);\">Ver His.Clinica</a></td>
                                  </tr>";
                        }
                    }
                } else {
                    foreach ($resultado as $fila) {
                        echo "<tr>
                                ...
                                <td>{$fila['especializacion']}</td>
                                <td>{$fila['estado']}</td>
                                <td><a href='' class='btn__autorizar' onclick=\"window.open('../verhistoria/verhisto_clinica.php?id_cita={$fila['id_cita']}','','width=1000,height=700,toolbar=NO');void(null);\">Ver His.Clinica</a></td>
                              </tr>";
                    }
                }
                ?>
