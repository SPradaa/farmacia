...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO autorizaciones (cod_auto, id_medicamento, presentacion, cantidad, fecha_hora_auto, fecha_venc, documento, docu_medico, fecha) 
            VALUES (:cod_auto, :id_medicamento, :presentacion, :cantidad, :fecha_hora_auto, :fecha_venc, :documento, :docu_medico, :fecha)";
