...
<head>
    ...
    <script>
        ...
        function validateForm() {
            const isRolValid = validateField(/^([a-zA-ZáéíóúÁÉÍÓÚñÑ\s]){4,20}$/, document.getElementById("rol"), "Ingrese un nombre válido (solo letras)");
...
<body>
    ...
    <img src="../../../../assets/img/log.farma.png">
        ...
        <form method="POST" name="formreg" autocomplete="off">
            <div class="campos">
                <input type="text" name="rol" id="rol" placeholder="Ingrese el Rol">
            </div>
            
            <a href="index_tip_usu.php" class="btn btn__danger">Cancelar</a>
