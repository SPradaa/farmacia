...
<head>
    ...
    <script>
        ...
        function validateForm() {
            const isRolValid = validateField(/^([a-zA-ZáéíóúÁÉÍÓÚñÑ\s]){4,30}$/, document.getElementById("rol"), "Ingrese un nombre válido (solo letras)");
...
<body>
    ...
    <img src="../../../../assets/img/log.farma.png">
        ...
        <form method="POST" name="formreg" autocomplete="off">
            <div class="campos">
                <input type="text" name="rol" id="rol" value="<?php echo $usua['rol']?>">
            </div>
