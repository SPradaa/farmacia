<?php
    ...
    $sql = $con -> prepare ("SELECT * FROM t_documento WHERE t_documento.id_doc = '".$_GET['id_doc']."'");
    $sql -> execute();
    $usua =$sql -> fetch();
?>
...
if(isset($_POST["update"]))
 {
    ...
    $insertSQL = $con -> prepare("UPDATE t_documento SET tipo = '$tipo' WHERE id_doc = '".$_GET['id_doc']."'");      
    $insertSQL->execute();
...
<body>
    ...
    <img src="../../../../assets/img/log.farma.png">
        ...
        <form method="POST" name="formreg" autocomplete="off">
            <div class="campos">
                <input type="text" name="tipo" id="tipo" value="<?php echo $usua['tipo']?>">
            </div>
