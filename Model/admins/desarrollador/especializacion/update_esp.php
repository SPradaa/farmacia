<?php
    ...
    $sql = $con -> prepare ("SELECT * FROM especializacion WHERE especializacion.id_esp = '".$_GET['id_esp']."'");
    $sql -> execute();
    $usua =$sql -> fetch();
?>
...
if(isset($_POST["update"]))
 {
    ...
    $insertSQL = $con -> prepare("UPDATE especializacion SET especializacion = '$especializacion' WHERE id_esp = '".$_GET['id_esp']."'");      
    $insertSQL->execute();
...
<body>
    ...
    <img src="../../../../assets/img/log.farma.png">
        ...
        <form action="" method="post">
            <div class="row">
            <input type="text" name="especializacion" id="especializacion" value="<?php echo $usua['especializacion']?>">
            </div>
