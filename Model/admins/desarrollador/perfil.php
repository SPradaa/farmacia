...
<head>
    ...
    <script>
        ...
        function validateForm() {
            ...
            return isCorreoValid && isTelefonoValid && isDireccionValid;
        }
    </script>
            ...
            <form class="form-horizontal form-material mx-2" method="POST">
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <h4 id="documento"><?php echo $_SESSION['documento'];; ?></h4>
                        <input type="hidden" value=" <?php echo $_SESSION['documento'];?>" class="form-control form-control-line" disabled>
                    </div>
                    <div class="col-md-6">
                        <label>Nombre Completo:</label>
                        <h4 id="nombre"><?php echo $nombre_comple; ?></h4>
                        <input type="hidden" placeholder="<?php echo $nombre_comple ;?>" class="form-control form-control-line" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-6">
