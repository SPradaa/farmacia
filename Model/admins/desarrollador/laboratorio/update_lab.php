<?php
    ...
    $sql = $con -> prepare ("SELECT * FROM laboratorio WHERE laboratorio.id_lab = '".$_GET['id_lab']."'");
    $sql -> execute();
    $usua =$sql -> fetch();
?>
...
if(isset($_POST["update"]))
 {
    ...
    $insertSQL = $con -> prepare("UPDATE laboratorio SET laboratorio = '$laboratorio' WHERE id_lab = '".$_GET['id_lab']."'");      
    $insertSQL->execute();
...
<body>
    ...
    <img src="../../../../assets/img/log.farma.png">
        ...
        <form method="POST" name="formreg" autocomplete="off">
            <div class="campos">
                <input type="text" name="laboratorio" id="laboratorio" value="<?php echo $usua['laboratorio']?>">
            </div>
