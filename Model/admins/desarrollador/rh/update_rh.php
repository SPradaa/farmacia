<?php
    ...
    $sql = $con -> prepare ("SELECT * FROM rh WHERE rh.id_rh = '".$_GET['id_rh']."'");
    $sql -> execute();
    $usua =$sql -> fetch();
?>
...
if(isset($_POST["update"]))
 {
    ...
    $insertSQL = $con -> prepare("UPDATE rh SET rh = '$rh' WHERE id_rh = '".$_GET['id_rh']."'");      
    $insertSQL->execute();
...
<body>
    ...
    <img src="../../../../assets/img/log.farma.png">
        ...
        <form method="POST" name="formreg" autocomplete="off">
            <div class="campos">
                <input type="text" name="rh" id="rh" value="<?php echo $usua['rh']?>">
            </div>
