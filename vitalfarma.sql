...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2024 a las 09:50:51
...
INSERT INTO `autorizaciones` (`cod_auto`, `fecha`, `documento`, `docu_medico`, `id_medicamento`, `presentacion`, `cantidad`, `fecha_venc`, `id_estado`) VALUES
('001', '2024-06-11', 1110172890, 1056769478, 2, 'tableta', '20', '2024-06-30', 13);
...
(20, 1005717713, '2024-06-06', '11:23:43', 1056769478, 1, 1),
(21, 1006123134, '2024-06-05', '09:27:11', 1056769478, 1, 1),
(22, 1023870638, '2024-06-05', '08:27:11', 1056769478, 1, 1),
(24, 1110172890, '2024-06-11', '17:00:00', 1056769478, 1, 11);
...
--
-- Volcado de datos para la tabla `det_autorizacion`
--

INSERT INTO `det_autorizacion` (`id_detalle`, `id_auto`, `id_medicamento`, `cantidad`, `medida_cant`) VALUES
(1, 1, 2, '75UND', 'pastillas100ml');
...
--
-- Volcado de datos para la tabla `histo_clinica`
--

INSERT INTO `histo_clinica` (`id_histo`, `fecha`, `documento`, `docu_medico`, `descripcion`, `diagnostico`) VALUES
(100, '2024-06-11', 1110172890, 1056769478, 'dasdsf', 'safasf');
...
(2, 'amoxicilina', 1, 'tableta', '75UND', '500mg', 9, '2025-05-07', '0883572', 7);
...
(1056769478, 3, 'Juan Ortega', 'Ortega201610@gmai.com', '3152903515', '$2y$10$nQaCB676jf6D3CaX2DHwx.fC9c0QwCS.kRIyg4Y4zpDoSGQQCboxS', 3, 3, 1, '45685297'),
(1102378951, 3, 'Laura Camila Ramirez', 'Lauramirez@gmail.com', '3152134312', '38211887', 3, 3, 14, '12378945'),
(1104786412, 3, 'yareth ohany garcia rangel', 'yogarcia@gmail.com', '3123122213', 'undefined ', 3, 3, 4, '45685297'),
(1108982783, 3, 'Isabella Rios ', 'isa10256@gmail.com', '3125468787', 'undefined.', 3, 3, 5, '957284163'),
(1122736351, 3, 'Jeferson Cardenal', 'jefer23@gmail.com', '3002349008', 'jefer123', 3, 3, 15, '957284163');
...
('$2y$10$38Y5VeED/nkAfSwUwAUrruFRb.WFCYI9x9Io4Pqg.ZhfP8uyXOcTO', '$2y$10$38Y5VeED/nkAfSwUwAUrruFRb.WFCYI9x9Io4Pqg.ZhfP8uyXOcTO', 'update', '2024-06-08 13:06:12');
...
(1110172890, 3, 'Valentina', 'Mendoza', 7, '3158571494', 'valen.mza.28@gmail.com', 173, 'Barrio Ricaute', '$2y$10$38Y5VeED/nkAfSwUwAUrruFRb.WFCYI9x9Io4Pqg.ZhfP8uyXOcTO', 5, 4, '45685297', ''),
...
--
ALTER TABLE `histo_clinica`
  MODIFY `id_histo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
